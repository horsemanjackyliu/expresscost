package com.sap.cap.expresscost.handlers;
...
import com.sap.cap.expresscost.handlers.MD5Utils;   
...
public class ExpressService implements EventHandler {
    ...
    @On(event = CqnService.EVENT_CREATE, entity = "ExpressService.Wuliu")
    ...
    @On(event = CqnService.EVENT_READ, entity = "ExpressService.Wuliu")
    public void onRead(CdsReadEventContext context) {
        ...
        String resultData = httpPostWithForm(url, params, headers);
